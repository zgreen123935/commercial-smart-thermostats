<template>
  <div class="min-h-screen bg-background">
    ...
    <div class="pt-16 px-4">
      <h2 class="font-roboto text-headline-small text-on-surface mb-6">Select Cooling Type</h2>
      <div class="space-y-2">
        <RadioCell
          v-model="currentValue"
          value="single-stage"
          header="Single Stage"
          helper="System has one cooling stage"
        />
        <RadioCell
          v-model="currentValue"
          value="two-stage"
          header="Two Stage"
          helper="System has two cooling stages"
        />
      </div>
...
export default {
  ...
  setup() {
    ...
    const handleNext = () => {
      store.commit('site/setCoolingType', currentValue.value)
